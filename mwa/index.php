...
<?php get_sidebar();?>
		<td width="697" align="left" valign="top" id="rightpan">
					...
					Pellentesque nec massa. Donec tempus eleifend lectus. Vivamus ero
					accumsan consequat mi. Fusce varius, tellus eget dictum lacinia.</p>
					
					<p>Praesent nec ligula vitae ipsum mattis ultrices. Nulla tincidunt.
					Cras dolor leo, rhoncus aliquet, auctor id, feugiat quis, metus
					amet. Quisque purus est, consequat in, gravida vitae, fermentum vel,
					risus.</p>
